...
function playGame() {
    ...
    if(humanScore > computerScore) {
        console.log("You're Win! this game with score " + "You: " + humanScore + " VS Computer " +  computerScore)
    } else {
        console.log("You're Lose! this game with score " + "You: " + humanScore + " VS Computer " +  computerScore)
    }
